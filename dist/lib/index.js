...
var StkrSdk = /** @class */ (function () {
    function StkrSdk(_keyProvider, _contractManager) {
        this._keyProvider = _keyProvider;
        this._contractManager = _contractManager;
    }
    StkrSdk.factoryWithMetaMask = function (providerConfig, contractConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var keyProvider, contractManager;
    ...
    StkrSdk.prototype.createMicroPool = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._contractManager.initializePool(name)];
                    case 1:
                        txHash = _a.sent();
