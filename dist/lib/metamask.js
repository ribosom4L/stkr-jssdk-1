...
var MetaMaskProvider = /** @class */ (function (_super) {
    ...
    MetaMaskProvider.prototype.unlockAccounts = function (ethereum) {
        return __awaiter(this, void 0, void 0, function () {
            var unlockedAccounts, result, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, ethereum.send('eth_requestAccounts')];
                    case 2:
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (Number(ethereum.networkVersion) !== Number(this.providerConfig.networkId)) {
                            console.error("ethereum networks mismatched " + ethereum.networkVersion + " != " + this.providerConfig.networkId);
                            /*throw new Error('MetaMask ethereum network mismatched, please check your MetaMask network.')*/
                        }
                        return [4 /*yield*/, this.unlockAccounts(ethereum)];
                    case 1:
                        _a.sent();
                        ethereum.on('accountsChanged', function (accounts) {
                            ...
                            if ((newAccount === null || newAccount === void 0 ? void 0 : newAccount.toLowerCase()) !== ((_a = _this._currentAccount) === null || _a === void 0 ? void 0 : _a.toLowerCase())) {
                                console.log("You've changed MetaMask account, reloading page (" + _this._currentAccount + " != " + newAccount + ")");
    ...
    MetaMaskProvider.prototype.invoke = function (from, to, sendOptions) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var tx;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        tx = {
                            chainId: web3_utils_1.numberToHex(this.providerConfig.chainId),
                        ...
                        return [4 /*yield*/, ((_b = (_a = this._web3) === null || _a === void 0 ? void 0 : _a.currentProvider) === null || _b === void 0 ? void 0 : _b.request({
